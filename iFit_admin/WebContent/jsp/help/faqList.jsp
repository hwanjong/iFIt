	...
	<body>
		...
		<div class="admin_container">
			...
			<div class="adminContentArea">
				<h2 class="mb20"><span>자주하는질문 목록</span></h2>
				<div class="contentBody">
					<s:form id="faq" name="faqList" cssClass="dib" method="get" namespace="/help" action="faqList" theme="simple">
						...
						<table class="table_list tc">
							...
							<tbody>
								...
								<s:iterator value="dataList" status="stat">
									<tr>
										<td class="center"><s:property value="faq_seq"/></td>
										<td class="center"><p class="viewBtn pointer hoverLine" data-seq="<s:property value="faq_seq"/>"><s:property value="title"/></p></td>
										<td class="center">
											<i class="editBtn mr10 fa fa-pencil-square-o" aria-hidden="true" title="편집" data-seq="<s:property value="faq_seq"/>" > </i>
											<i class="deleteBtn fa fa-trash-o" aria-hidden="true" title="삭제" data-seq="<s:property value="faq_seq"/>" data-title="<s:property value="title"/>"></i>
										</td>
									</tr>
								</s:iterator>
							</tbody>
